...
export interface BodyDefinition {
  ...
  npcMaxHp?: number;
  /** Неподвижный объект-существо (Машина Переноса): не двигается, не ищет
   *  фракционных врагов, не атакует — но имеет HP-бар и может быть целью фракций. */
  immobile?: boolean;
  /** Тварь Пустоты: полуматериальна — обычная (basic) атака наносит 30% урона,
   *  выученные умения/заклинания (резонанс) — полный. */
  voidResistant?: boolean;
}
