...
const SWORDSMAN_SPRITES: MobSpriteSet = {
  ...
  frameW: 128, frameH: 128,
  anims: {
    front_idle:     { file: 'idle.webp',    frames: 8 },
    front_walk:     { file: 'walk.webp',    frames: 8 },
    front_attack:   { file: 'attack.webp',  frames: 6 },
    dying:          { file: 'dead.webp',    frames: 3 },
  },
};
...
const ARCHER_SPRITES: MobSpriteSet = {
  ...
  frameW: 128, frameH: 128,
  anims: {
    front_idle:     { file: 'idle.webp',    frames: 6 },
    front_walk:     { file: 'walk.webp',    frames: 8 },
    front_attack:   { file: 'attack.webp',  frames: 14 },
    dying:          { file: 'dead.webp',    frames: 3 },
  },
};
...
const WIZARD_SPRITES: MobSpriteSet = {
  ...
  anims: {
    front_idle:     { file: 'idle.webp',    frames: 6 },
    front_walk:     { file: 'walk.webp',    frames: 7 },
    front_attack:   { file: 'attack.webp',  frames: 10 },
    dying:          { file: 'dead.webp',    frames: 4 },
  },
};
