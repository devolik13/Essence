...
// ── Craftable Weapons T1-T3 ──────────────────────────────────────────────
  ...
  shield_t1: { id: 'shield_t1', nameRu: 'Стальной щит', nameEn: 'Steel Shield', rarity: 'common', type: 'equipment', equipSlot: 'shield', descRu: 'Блок 2: −2 урона с каждого прямого удара (физ/маг, не DoT) · только меч/булава', descEn: 'Block 2: −2 damage from every direct hit (phys/magic, not DoT) · Sword/Mace only', icon: '🛡', shieldBlock: 2 },
  shield_t2: { id: 'shield_t2', nameRu: 'Закалённый щит', nameEn: 'Tempered Shield', rarity: 'uncommon', type: 'equipment', equipSlot: 'shield', descRu: 'Блок 4: −4 урона с каждого прямого удара (физ/маг, не DoT) · только меч/булава', descEn: 'Block 4: −4 damage from every direct hit (phys/magic, not DoT) · Sword/Mace only', icon: '🛡', shieldBlock: 4 },
  ...
  shield_t3: { id: 'shield_t3', nameRu: 'Мастерский щит', nameEn: 'Masterwork Shield', rarity: 'rare', type: 'equipment', equipSlot: 'shield', descRu: 'Блок 6: −6 урона с каждого прямого удара (физ/маг, не DoT) · только меч/булава', descEn: 'Block 6: −6 damage from every direct hit (phys/magic, not DoT) · Sword/Mace only', icon: '🛡', shieldBlock: 6 },
