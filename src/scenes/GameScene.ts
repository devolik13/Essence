...
import { MOB_NEUTRAL_T1, MOB_NEUTRAL_T2, MOB_NEUTRAL_HEAL } from '../data/neutralSpells';
import {
...
import {
  MOB_FIRE_T1, MOB_FIRE_T2, ENCHANT_FIRE,
  MOB_WATER_T1, MOB_WATER_T2, ENCHANT_WATER,
  MOB_EARTH_T1, MOB_EARTH_T2, ENCHANT_EARTH,
  MOB_WIND_T1, MOB_WIND_T2, ENCHANT_WIND,
...
export class GameScene extends Phaser.Scene {
  ...
  MOB_NEUTRAL_T1, MOB_NEUTRAL_T2, MOB_NEUTRAL_HEAL, ABILITY_STING, ABILITY_KNIFE_THROW,
  ABILITY_SWORD_STRIKE, ABILITY_DOUBLE_STRIKE,
  ABILITY_MACE_STRIKE, ABILITY_MACE_BASH,
  ABILITY_SLASH, ABILITY_SLASH_SWEEP,
  ABILITY_BOW_SHOT, ABILITY_BOW_BACKSHOT,
